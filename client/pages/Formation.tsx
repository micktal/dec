          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            ...
            {!isFullscreen && (
              <button
                onClick={toggleFullscreen}
                type="button"
                className="inline-flex items-center justify-center rounded-[12px] border border-primary/40 bg-primary/5 px-5 py-2 text-sm font-semibold text-primary transition-all duration-300 hover:-translate-y-0.5 hover:border-primary hover:bg-primary/10"
              >
